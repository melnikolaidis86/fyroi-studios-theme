...
<section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url('<?php echo get_template_directory_uri() ?>/assets/images/big_image_1.jpg');">
    <div class="container">
...
<section class="site-section">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-7">
                <img src="<?php echo get_template_directory_uri() ?>/assets/images/f_img_1.png" alt="Image placeholder" class="img-md-fluid">
            </div>
        </div>
    </div>
</section>
...
<section class="section-cover" data-stellar-background-ratio="0.5" style="background-image: url('<?php echo get_template_directory_uri() ?>/assets/images/img_5.jpg');">
    <div class="container">
        ...
        <div class="row ">
            <div class="col-md-4">
                <div class="post-entry">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/images/img_3.jpg" alt="Image placeholder" class="img-fluid">
                    <div class="body-text">
            ...
            <div class="col-md-4">
                <div class="post-entry">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/images/img_6.jpg" alt="Image placeholder" class="img-fluid">
                    <div class="body-text">
            ...
            <div class="col-md-4">
                <div class="post-entry">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/images/img_5.jpg" alt="Image placeholder" class="img-fluid">
                    <div class="body-text">
